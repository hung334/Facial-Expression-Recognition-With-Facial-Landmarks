...
save_local_path = r'C:\Users\chen_hung\Desktop\長庚科大_數據集\outputs'  
#輸出答案
...
ER_model_1 = joblib.load(r'C:\Users\chen_hung\Desktop\長庚科大_數據集\save_model\ExtraTreesRegressor_1_fold_0.9924351845027015')
ER_model_2 = joblib.load(r'C:\Users\chen_hung\Desktop\長庚科大_數據集\save_model\ExtraTreesRegressor_2_fold_0.9925145379654341')
ER_model_3 = joblib.load(r'C:\Users\chen_hung\Desktop\長庚科大_數據集\save_model\ExtraTreesRegressor_3_fold_0.9924003665750458')
ER_model_4 = joblib.load(r'C:\Users\chen_hung\Desktop\長庚科大_數據集\save_model\ExtraTreesRegressor_4_fold_0.9921372119815296')
ER_model_5 = joblib.load(r'C:\Users\chen_hung\Desktop\長庚科大_數據集\save_model\ExtraTreesRegressor_5_fold_0.9922799079899105')

print(ER_model_1 )

ExtraTreesRegressor_f = np.load(r"C:\Users\chen_hung\Desktop\長庚科大_數據集\ExtraTreesRegressor_Feature_Importance.npy")
...
def test_CV(path,start=0,end=None,wait=1):
    ...
    while True:
            ...
            if(len(input_data)>1):
                ...
                ans_score = ER_model_5.predict(df[select_ExtraTrees].values[:,2:-1])
                ans_score+=ER_model_4.predict(df[select_ExtraTrees].values[:,2:-1])
                ans_score+=ER_model_3.predict(df[select_ExtraTrees].values[:,2:-1])
                ans_score+=ER_model_2.predict(df[select_ExtraTrees].values[:,2:-1])
                ans_score+=ER_model_1.predict(df[select_ExtraTrees].values[:,2:-1])
                ans_score = ans_score/5
                bb = time.time()
